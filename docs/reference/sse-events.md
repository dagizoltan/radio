...
| `vu` | Recorder Task (per ALSA period, ~85ms at 4096 frames / 48000 Hz) | Dual VU Meters | `{"left": number, "right": number}` | Peak absolute sample values (`0-32768`) for the last 50ms block. |
