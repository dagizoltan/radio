...
4. **Task 2: Converter:** A separate converter task consumes the raw audio and encodes it directly into multiple qualities (HQ FLAC and LQ Opus) without any signal processing.
