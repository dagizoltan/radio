...
- **HQ Segment Size:** 10s × 48000 Hz × 3 bytes × 2 channels = **2,880,000 bytes (~2.88 MB)** *(approximate nominal target; actual chunks vary slightly around this due to 4096-frame boundary alignment)*
